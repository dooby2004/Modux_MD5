    ...
    public class MD5Methods
    {
        ...
        public static byte[] EncryptMD5(byte[] input)
        {
            ...
            for (int i = 0; i < words.Length / 16; i++)
            {
                ...
                for (int j = 16; j < 32; j++)
                {
                    t = b + LShift(a + g5(b, c, d) + x[(5 * j + 1) % 16] + sines[j], s[j]);
                    a = d;
                    d = c;
                    c = b;
                    b = t;
                ...
                for (int j = 32; j < 48; j++)
                {
                    t = b + LShift(a + h(b, c, d) + x[(3 * j + 5) % 16] + sines[j], s[j]);
                    a = d;
                    d = c;
                    c = b;
                    b = t;
                ...
                for (int j = 48; j < 64; j++)
                {
                    t = b + LShift(a + i5(b, c, d) + x[(7 * j) % 16] + sines[j], s[j]);
                    a = d;
                    d = c;
                    c = b;
                    b = t;
